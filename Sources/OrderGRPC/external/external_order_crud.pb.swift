...
extension CreateOrderRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    2: .standard(proto: "animal_id"),
    3: .standard(proto: "subway_station_id"),
    4: .same(proto: "title"),
    5: .same(proto: "price"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        switch fieldNumber {
        case 1: try { try decoder.decodeSingularInt64Field(value: &_storage._profileID) }()
        case 2: try { try decoder.decodeSingularInt64Field(value: &_storage._animalID) }()
        case 3: try { try decoder.decodeSingularInt32Field(value: &_storage._subwayStationID) }()
        case 4: try { try decoder.decodeSingularStringField(value: &_storage._title) }()
        case 5: try { try decoder.decodeSingularInt64Field(value: &_storage._price) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if _storage._profileID != 0 {
        try visitor.visitSingularInt64Field(value: _storage._profileID, fieldNumber: 1)
      }
      if _storage._animalID != 0 {
        try visitor.visitSingularInt64Field(value: _storage._animalID, fieldNumber: 2)
      }
